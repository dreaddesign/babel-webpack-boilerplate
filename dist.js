...
var busyButtonClick = function busyButtonClick(activitySelector) {
    activitySelector.click(function (event) {
        console.log('js busy button was clicked');
        (0, _jquery2.default)('.js-onscreen-activity').append('<h1>Busy</h1>');
    });
};

busyButtonClick((0, _jquery2.default)('.js-busy-button'));

exports.default = busyButtonClick;
...
var _busyButtons = __webpack_require__(0);

var _busyButtons2 = _interopRequireDefault(_busyButtons);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _busyButtons2.default)('.js-onscreen-activity');
